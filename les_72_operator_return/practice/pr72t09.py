...
# Необходимо их прочитать и сохранить в списке digs. Затем (или в самом начале программы), объявить функцию, 
# которая имеет два параметра (будут передаваться максимальное и минимальное значения из сформированного списка digs) 
